                        ...
                        <div class='col-md-4 col-xs-6' >
								<div class='product'>
									<div class='product-img'>
										<img src='img/product1.jpg' style='max-height: 250px;' alt=''>
	...
	if (isset($_POST["getCartItem"])) {
		...
		if (mysqli_num_rows($query) > 0) {
            ...
            echo '<div class="cart-summary">
				    <small class="qty">'.$n.' สินค้าที่เลือก</small>
				    <h5>'.$total_price.'</h5>
				</div>'
            ?>
	               ...
	               <table id="cart" class="table table-hover table-condensed" id="">
    				<thead>
						<tr>
							...
							<th style="width:7%" class="text-center">ราคารวม</th>
						...
						<tr>
							<td data-th="Product" >
								<div class="row">
									...
									<div class="col-sm-4 "><img src="img/product1.jpg" style="height: 70px;width:75px;"/>
									<h4 class="nomargin product-name header-cart-item-name">'.$product_title.'</h4>
									</div>
									<div class="col-sm-6">
